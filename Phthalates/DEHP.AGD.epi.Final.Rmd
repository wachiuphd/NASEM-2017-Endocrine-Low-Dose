---
title: "DEHP.AGD.epa.FinalDraft.Rmd"
...
```{r kable}
library(knitr)
dat <- read.delim("DEHP.AGD.epi.FinalDraft.txt",sep="\t",header=TRUE,as.is=TRUE)
...
rownames(meta.alt.table)<-NULL
write.csv(rbind(meta.table,meta.alt.table),file="DEHP.AGD.epi.results.FinalDraft.csv")
